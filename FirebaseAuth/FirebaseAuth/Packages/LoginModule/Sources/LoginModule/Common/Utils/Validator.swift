...
enum ValidationError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .invalidEmail:
            return LocalResources.Strings.Validation.invalidEmail
        case .passwordTooShort:
            return LocalResources.Strings.Validation.passwordTooShort
        case .passwordMissingUppercase:
            return LocalResources.Strings.Validation.passwordMissingUppercase
        case .passwordMissingLowercase:
            return LocalResources.Strings.Validation.passwordMissingLowercase
        case .passwordMissingDigit:
            return LocalResources.Strings.Validation.passwordMissingDigit
        case .passwordsAreNotEqual:
            return LocalResources.Strings.Validation.passwordsAreNotEqual
        }
    }
}
